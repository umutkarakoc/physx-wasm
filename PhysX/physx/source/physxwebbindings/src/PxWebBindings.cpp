...
EMSCRIPTEN_BINDINGS(physx)
{
  ...
  class_<PxJoint>("PxJoint")
      ...
      .function("setInvMassScale0", &PxJoint::setInvMassScale0, allow_raw_pointers())
  ...
  .function("getAngle", &PxRevoluteJoint::getAngle)
    ...
    .function("setDriveVelocity", &PxRevoluteJoint::setDriveVelocity, allow_raw_pointers())
    .function("getDriveVelocity", &PxRevoluteJoint::getDriveVelocity)
    .function("setDriveForceLimit", &PxRevoluteJoint::setDriveForceLimit, allow_raw_pointers())
    .function("getDriveGearRatio", &PxRevoluteJoint::getDriveGearRatio)
    .function("setRevoluteJointFlags", &PxRevoluteJoint::setRevoluteJointFlags, allow_raw_pointers())
    .function("getRevoluteJointFlags", &PxRevoluteJoint::getRevoluteJointFlags)
